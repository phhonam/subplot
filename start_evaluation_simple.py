#!/usr/bin/env python3
"""
Simple startup script for the Movie Profile Evaluation System

This script starts the evaluation API server without initializing LLM components
at startup to avoid hanging issues.
"""
...
def check_requirements():
    ...
    required_files = [
        ...
        '.env',
        'evaluation_api.py',
        'templates/evaluation_dashboard.html'
    ]
...
def check_dependencies():
    ...
    required_packages = ['flask', 'openai', 'numpy']
    missing_packages = []
...
def main():
    ...
    print("   - LLM components will initialize when first evaluation is run")
    print()
